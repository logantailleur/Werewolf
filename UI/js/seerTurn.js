...
function initializeApp() {
    ...
    if (isSeer) {
        actionDescription.innerHTML = "<p>Choose a player to see if they are a werewolf</p>";
    } else {
        ...
        actionDescription.innerHTML = "<p>You are asleep. The seer is trying do find out who the werewolves are...</p>";
    }
}
